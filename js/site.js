      ...
      root.innerHTML =
        ...
        '<div class="modal-dialog">' +
          ...
          '<form class="modal-form" id="modalApptForm" novalidate>' +
            ...
            '</div>' +
            '<div class="field"><label for="m_message">How can we help? <span class="muted" style="font-weight:400;">(optional)</span></label><textarea class="textarea" id="m_message" name="message" placeholder="Share anything you\'d like us to know. This is completely confidential."></textarea></div>' +
